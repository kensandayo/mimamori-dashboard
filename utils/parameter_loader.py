...
from utils.config import PARAMETER_MASTER_PATH

_FIELDNAMES = [
    "param_id", "label", "csv_column", "unit", "risk_direction",
    "weight", "description", "source", "active",
]
...
def add_parameter(
    ...
    weight: float, description: str = "", source: str = "", active: bool = True,
    ...
    params.append({
        "param_id": param_id, "key": csv_column, "label": label, "unit": unit,
        "risk_direction": risk_direction, "weight": weight, "description": description,
