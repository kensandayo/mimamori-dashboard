...
2_📊_ランキング.py
--------------------
全地区を一覧表示し、並び替え・検索ができる画面です。
"""

import streamlit as st

from utils.config import APP_TITLE, COL_NAME, COL_RANK, COL_SCORE, COL_PRIORITY, COL_AGING, COL_SINGLE_ELDERLY, COL_MEDICAL, COL_TRANSPORT
from utils.state import init_state, get_scored_data
from components.header import render_header, render_footer

st.set_page_config(page_title=f"ランキング | {APP_TITLE}", page_icon="📊", layout="wide")
init_state()
